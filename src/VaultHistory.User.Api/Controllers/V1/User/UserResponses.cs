...
{
    public sealed record GetByEmailResponse (string Id, string FirstName, string LastName, string Email, DateOnly BirthDate, bool IsActive);
    public sealed record GetByIdResponse(string Id, string FirstName, string LastName, string Email, DateOnly BirthDate, bool IsActive);
